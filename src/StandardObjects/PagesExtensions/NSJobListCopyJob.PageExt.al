/// <summary>
/// Page NS Copy Job Tasks (ID 14021493).
/// </summary>
//PRJ-1616.AS.1.0 29SEPT2022-Add New Page for Copy Job task functionality.
page 14021396 "NS Copy JobList"
{
    Caption = 'Copy Job';
    ...
    begin
        if CloseAction in [ACTION::OK, ACTION::LookupOK] then begin
            ...
            ValidateUserInput;
            CopyJob.SetCopyQuantity(CopyQuantity);//EXTRA
