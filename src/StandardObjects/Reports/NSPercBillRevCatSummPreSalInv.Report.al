report 14021234 "NS_PercBill-RevCatSumPreSalInv"
{
    // version NAVNA13.01
    ...
    //CTSI-150.AS.1.0 28Sept2020 New Report by saving extended 14021231 report
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/NSPerc Bill -RevCat SummPreSalInvoice.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                DataItemTableView = SORTING("NS_Job Revenue Category") ORDER(Ascending);
                    ...
                    dataitem(SalesInvLine; Integer)
                    {
                        ...
                        begin
                            ...
                            WITH TempSalesInvoiceLine DO BEGIN
                                ...
                                //ScheduledValue := "From Prog. Billing Base Amount";
