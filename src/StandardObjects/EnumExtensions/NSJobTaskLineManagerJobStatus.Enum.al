...
{ //',Estimating,Quoting,Verbal App,Approval,Planning,Running,Hold,Completed,Billed,Paid,Closed'
  //,Estimating,Quoting,Verbal App,Budget Review,Manufacturing,Handover,Site Works,Completed,Closed - no more Cost,Paid,Closed,Storage,Planning
  // a3b03edf-3f59-46a5-9644-a1f4a6b1d289
    ...
    {
        Caption = 'Budget Review'; //PE-193.PS.1.0 29Nov2023
    }
    //value(5; Planning) { }
