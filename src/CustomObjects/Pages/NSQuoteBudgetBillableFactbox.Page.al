page 14021437 "NS_QuoteBudget/BillableFactBox"
{
    ...
    // 002  2021.11.02  PREM RG007-58 Job Details
    // 001  2019.07.04  #146  tad  Fixes
    // // FDD108 RP 2018-12-14 Changed the calculation of AdjustmentBudgetCost and AdjustmentBudgetPrice to exclude sub jobs.
    ...
    layout
    {
        area(content)
        {
            ...
            field("QuotedGP$1"; FORMAT("QuotedGP$", 14, '<Precision,2:2><Sign><Integer Thousand><Decimals>'))
            {
