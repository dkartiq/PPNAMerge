/// <summary>
/// Page NS_ProjProManagerLite (ID 14021139).
/// </summary>
page 14021139 "NS_ProjProManagerLite"
{
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            group(Control1900724808)
            {
                ...
                //PRJCTPR-168.JS.1.0 26-Sep-2023 - Start
                ...
                //PRJCTPR-168.JS.1.0 26-Sep-2023 - end
    ...
    actions
    {
        ...
        area(embedding)
        {
            ...
            group("NS_Payroll Interfacce")
            {
                ...
                action(PP_LedhJournal)
                {
                    ...
                    RunObject = page "NS_Payroll Register Ledger Ent";
                }
                //PRJ-1534.JS.1.0 22JULY2022 end  Only for OnPrem Version
            }
        }    //PRJ-1442.JS.1.0 07JUN2022

        //PRJ-1534.JS.1.0 22JUN2022 - Start - Block Only for Cloud Version
        ...
        //PRJ-1534.JS.1.0 22JUN2022 - End - Block Only for Cloud Version
        area(sections)
        {
            group(Journals)
            {
            ...
            group("NS_ProjectProReports")
            {
                ...
                group("NS_Finance")
                {
                    ...
                    action("NS_Aged Accounts Payable")
                    {
                        ...
                        Tooltip = 'Job Aged Accounts Payable';//PE-141.NK.1.0 03Aug2023 updated name
                        Image = "Report";
                ...
                group("NS_Purchasing")
                {
                    ...
                    {
                        ApplicationArea = All;
                        Caption = 'JobOpen Vendor Entries';//PE-141.NK.1.0 03Aug2023 updated name
                    ...
                    // {
                    //     ApplicationArea = All;
                    //     Caption = 'Job Purchase Order'; comment by PE-141.NK.1.0 start 09Aug2023
                    //     Tooltip = 'Job Purchase Order'; comment by PE-141.NK.1.0 start 09Aug2023
