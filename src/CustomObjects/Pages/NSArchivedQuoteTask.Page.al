page 14021441 "NS_Archived Quote Task"
{
    // version PPNA11.00
    ...
    //PRJ-1102.RM.1.0 29Dec2021 | Removed with statement
    ...
    var
        ...
        //Text14021101Lbl: Label 'Current process @1@@@@@@@@@@@@@@@\';
        ...
        // Text14021114Lbl: Label 'Name';
        // Text14021115Lbl: Label 'Start';
        // Text14021116Lbl: Label 'Finish';
        // Text14021117Lbl: Label 'Resource Names';
        // Text14021118Lbl: Label 'Duration';
        // Text14021119Lbl: Label 'Work';
        // Text14021120Lbl: Label 'Actual Work';
        // Text14021121: Label 'Cost';
        // Text14021122: Label 'Cost1';
        // Text14021123: Label 'Predecessors';
        // Text14021124Lbl: Label 'Successors';
        // Text14021125Lbl: Label 'Current process @1@@@@@@@@@@@@@@@\';
        // Text14021126Lbl: Label 'There is no file name defined.';
        QuoteNo: Code[20];
    ...
    begin
        ...
        if PP_TempProjectLinkBuffer.FINDSET() then
            repeat
                if PP_JobTask.GET(PP_TempProjectLinkBuffer."NS_Job No.", PP_TempProjectLinkBuffer."NS_Task No.") then begin
                    PP_JobTask."NS_Task Start Date" := PP_TempProjectLinkBuffer."NS_Start Date";
        ...
        if PP_TempProjectLinkBuffer.FINDSET() then begin
            ...
            repeat
                if (PP_TempProjectLinkBuffer."NS_Job Task Type" = PP_TempProjectLinkBuffer."NS_Job Task Type"::Posting) and (PP_TempProjectLinkBuffer."NS_Line No." > 1) then begin
                    ...
                    if PP_TempProjectLinkBuffer."NS_Start Date" = 0D then begin
                        ...
                        if (PP_ProjLinkBuf.NS_Lag > 0) and (PP_ProjLinkBuf."NS_Finish Date" > 0D) then begin
                            ...
                            PP_TempProjectLinkBuffer."NS_Start Date" := NS_AddWorkingDays(PP_ProjLinkBuf."NS_Job No.", PP_TempProjectLinkBuffer."NS_Start Date", 0);
                        end else
                    ...
                    if PP_TempProjectLinkBuffer."NS_Start Date" > 0D then
                        PP_TempProjectLinkBuffer."NS_Finish Date" := NS_AddWorkingDays(PP_ProjLinkBuf."NS_Job No.", PP_TempProjectLinkBuffer."NS_Start Date", PP_TempProjectLinkBuffer.NS_Duration - 1);
                    ...
                    PP_ProjLinkBuf.SETCURRENTKEY("NS_Job No.", "NS_Task No.", "NS_Line No.");
                    PP_ProjLinkBuf.SETRANGE("NS_Job No.", PP_TempProjectLinkBuffer."NS_Job No.");
                    PP_ProjLinkBuf.SETRANGE("NS_Task No.", PP_TempProjectLinkBuffer."NS_Task No.");
                    if PP_ProjLinkBuf.FINDFIRST() then begin
                        PP_ProjLinkBuf."NS_Start Date" := PP_TempProjectLinkBuffer."NS_Start Date";
                        PP_ProjLinkBuf."NS_Finish Date" := PP_TempProjectLinkBuffer."NS_Finish Date";
                        PP_ProjLinkBuf.MODIFY()
                    end;

                    //Set the next start date
                    if PP_TempProjectLinkBuffer."NS_Finish Date" > 0D then
                        PP_NextStartDate := NS_AddWorkingDays(PP_ProjLinkBuf."NS_Job No.", PP_TempProjectLinkBuffer."NS_Finish Date", 1);
                end;
            until PP_TempProjectLinkBuffer.NEXT() = 0;
        end;
        //end;
        ...
        if PP_TempProjectLinkBuffer.FINDSET() then
            repeat
                if (PP_TempProjectLinkBuffer."NS_Job Task Type" = PP_TempProjectLinkBuffer."NS_Job Task Type"::Posting) and (PP_TempProjectLinkBuffer."NS_Line No." > 1) then begin
                    ...
                    PP_TaskBeforeHold := PP_TempProjectLinkBuffer."NS_Task No.";
                end;
            until PP_TempProjectLinkBuffer.NEXT() = 0;
