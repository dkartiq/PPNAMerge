page 14021387 "NS_PayrollInterfaceJnlPaylocit"
{
    // version PPNA11.00
    ...
    AutoSplitKey = true;
    Caption = 'Payroll Interface Jnl - Paylocity';
    PageType = Worksheet;
    SaveValues = true;
    ...
    procedure NS_PrintPayrollInterfaceJnlLine(NewPayrollInterfaceJnlLine: Record "NS_Payroll Interface Jnl Line");
    var
