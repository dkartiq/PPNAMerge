page 14021315 "NS_ProjectProAccountActivities"
{
    Caption = 'Activities';
    PageType = CardPart;
    ...
    layout
    {
        area(content)
        {
            ...
            {
                Caption = 'Payments';
                field("Purchase Documents Due Today"; Rec."NS_Purch. Documents Due Today")
                {
                    ApplicationArea = Basic, Suite;
                    DrillDownPageID = "Vendor Ledger Entries";
                    ToolTip = 'Specifies the number of purchase invoices that are due for payment today.';
                }
                field("Purch. Invoices Due Next Week"; Rec."NS_Purch Invoice Due Next Week")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number of payments to vendors that are due next week.';
                }
                field("Purchase Discounts Next Week"; Rec."NS_Purch Discounts Next Week")
                {
                    ApplicationArea = Basic, Suite;
            ...
            {
                Caption = 'Financials';
                field("Non-Applied Payments"; Rec."NS_Non-Applied Payments")
                {
                    ApplicationArea = Basic, Suite;
            ...
            cuegroup("Incoming Documents")
            {
                ...
                field("Approved Incoming Documents"; Rec."NS_Approved Incoming Documents")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("OCR Completed"; Rec."NS_OCR Completed")
                {
                    ApplicationArea = Basic, Suite;
                    DrillDownPageID = "Incoming Documents";
            ...
            cuegroup("Document Approvals")
            {
                ...
                field("POs Pending Approval"; Rec."NS_POs Pending Approval")
                {
                    ApplicationArea = Suite;
                    DrillDownPageID = "Purchase Order List";
                    ToolTip = 'Specifies the number of purchase orders that are pending approval.';
                }
                field("SOs Pending Approval"; Rec."NS_SOs Pending Approval")
                {
                    ApplicationArea = Suite;
