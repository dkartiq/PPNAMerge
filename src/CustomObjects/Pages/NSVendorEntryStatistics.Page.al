page 14021475 "NS_Vendor Entry Statistics"
{
    // version NAVW113.00
    //SPLN1.00 2019-02-07 DMT Copy of Page 303
    // +---------------------------------------------------------------------------------------------
    // +ProjectPro
    // +  - Added field(s):
    // +
    ...
    // +     - OnAfterGetRecord - Set Retention Ledger Code filtering if using retention - three places
    ...
    begin
        ...
        for j := 1 to 6 do begin
            ...
            //ProjectPro - start
            IF NOT PP_PurchSetup."NS_Purchase Retention Inactive" THEN
                VendLedgEntry[j].SETRANGE("NS_Retention Ledger Code", PP_PurchSetup."NS_Normal Vendor Ledger No.");
            //ProjectPro - end          
        ...
        //ProjectPro - start
        IF NOT PP_PurchSetup."NS_Purchase Retention Inactive" THEN
            VendLedgEntry2.SETRANGE("NS_Retention Ledger Code", PP_PurchSetup."NS_Normal Vendor Ledger No.");
        //ProjectPro - end        
