/// <summary>
/// Page Apply Customer Entries (ID 14021398).
/// </summary>
////PRJ-1108.GK.1.0 11Jan2022| add new page
///PRJ-1198.NK.1.0 14Feb2022| With Statement Changes for Warning AL0604 and AL0606
page 14021398 "NS_Apply Customer Entries"
{
    ...
    begin
        ...
        if ApplnType = ApplnType::"Applies-to Doc. No." then begin
            if OK then begin
                RaiseError := ApplyingCustLedgEntry."Posting Date" < Rec."Posting Date"; //PRJ-1198.NK.1.0 14Feb2022
    ...
    begin
        ...
        Rec.CopyFilters(NewCustLedgEntry); //PRJ-1198.NK.1.0 14Feb2022
        ...
        if SalesHeader."Tax Area Code" <> '' then begin
            ...
            //PRJ-1198.NK.1.0 14Feb2022 Start
    ...
    begin
        ...
        if CurrentRec then begin
            ...
            CustEntrySetApplID.SetApplId(CustLedgEntry, ApplyingCustLedgEntry, Rec."Applies-to ID") //PRJ-1198.NK.1.0 14Feb2022
        end else begin
            CurrPage.SetSelectionFilter(CustLedgEntry);
        ...
        case CalcType of
            CalcType::Direct:
                begin
                    ...
                    AppliedCustLedgEntry.SetRange("Customer No.", Rec."Customer No."); //PRJ-1198.NK.1.0 14Feb2022
                    ...
                    case ApplnType of
                        ApplnType::"Applies-to Doc. No.":
                            begin
                                ...
                                if Rec."Amount to Apply" <> 0 then //PRJ-1198.NK.1.0 14Feb2022
                                    AppliedAmount := Round(Rec."Amount to Apply", AmountRoundingPrecision) //PRJ-1198.NK.1.0 14Feb2022
                                else
                                    AppliedAmount := Round(Rec."Remaining Amount", AmountRoundingPrecision); //PRJ-1198.NK.1.0 14Feb2022
                                ...
                                if PaymentToleranceMgt.CheckCalcPmtDiscGenJnlCust(
                                   ...
                                   ((Abs(GenJnlLine.Amount) + ApplnRoundingPrecision >=
                                     Abs(AppliedAmount - Rec."Remaining Pmt. Disc. Possible")) or //PRJ-1198.NK.1.0 14Feb2022
                                    (GenJnlLine.Amount = 0))
                                then
                                    PmtDiscAmount := Rec."Remaining Pmt. Disc. Possible"; //PRJ-1198.NK.1.0 14Feb2022

                                if not DifferentCurrenciesInAppln then
                                    DifferentCurrenciesInAppln := ApplnCurrencyCode <> Rec."Currency Code"; //PRJ-1198.NK.1.0 14Feb2022
                                //end;
                                //PRJ-1198.NK.1.0 14Feb2022 End
                                CheckRounding();
                            end;
    ...
    begin
        ...
        if ApplnCurrencyCode = Rec."Currency Code" then //PRJ-1198.NK.1.0 14Feb2022
            exit(AmountToApply);
    ...
    begin
        if CalcType = CalcType::Direct then begin
            ...
            CustLedgEntry.SetRange("Customer No.", Rec."Customer No."); //PRJ-1198.NK.1.0 14Feb2022
            ...
            if CustLedgEntry.FindFirst() then begin
                ...
                Rec.SetFilter("Entry No.", '<>%1', CustLedgEntry."Entry No."); //PRJ-1198.NK.1.0 14Feb2022
    ...
    var
        ...
        NSApplyUnapplyPara: record "Apply Unapply Parameters";   //PRJCTPR-155.JS.1.0 10Sep2023
        NSApplyUnapplyPara2: record "Apply Unapply Parameters";   //PRJCTPR-155.JS.1.0 10Sep2023
        NSApplyUnapplyPara3: record "Apply Unapply Parameters";   //PRJCTPR-155.JS.1.0 10Sep2023        
        Applied: Boolean;
    ...
    begin
        ...
        if CalcType = CalcType::Direct then begin
            if ApplyingCustLedgEntry."Entry No." <> 0 then begin
                ...
                //PRJCTPR-155.JS.1.0 10Spe2023 - Start
                //PostApplication.SetValues(Rec."Document No.", ApplicationDate); //PRJ-1198.NK.1.0 14Feb2022  
                NSApplyUnapplyPara.Reset();
                NSApplyUnapplyPara.SetRange("Document No.", Rec."Document No.");
                NSApplyUnapplyPara.SetRange("Posting Date", ApplicationDate);
                if NSApplyUnapplyPara.FindSet() then
                    PostApplication.SetParameters(NSApplyUnapplyPara);
                //PRJCTPR-155.JS.1.0 10Spe2023 - end                 
                if ACTION::OK = PostApplication.RunModal then begin
                    //PRJCTPR-155.JS.1.0 10Spe2023 - Start
                    //PostApplication.GetValues(NewDocumentNo, NewApplicationDate);
                    NSApplyUnapplyPara2.Reset();
                    NSApplyUnapplyPara2.SetRange("Document No.", NewDocumentNo);
                    NSApplyUnapplyPara2.SetRange("Posting Date", NewApplicationDate);
                    if NSApplyUnapplyPara2.FindSet() then
                        PostApplication.GetParameters(NSApplyUnapplyPara2);
                    //PRJCTPR-155.JS.1.0 10Spe2023 - end                        
                    if NewApplicationDate < ApplicationDate then
                        Error(Text013, Rec.FieldCaption("Posting Date"), Rec.TableCaption); //PRJ-1198.NK.1.0 14Feb2022
                end else
                    Error(Text019);
                ...
                if PreviewMode then
                    ...
                    if PreviewMode then begin
                        ...
                        NSApplyUnapplyPara3.Reset();
                        NSApplyUnapplyPara3.SetRange("Document No.", NewDocumentNo);
                        NSApplyUnapplyPara3.SetRange("Posting Date", NewApplicationDate);
                        if NSApplyUnapplyPara3.FindSet() then
                            CustEntryApplyPostedEntries.PreviewApply(Rec, NSApplyUnapplyPara3);
                    end else begin
                        ...
                        NSApplyUnapplyPara3.SetRange("Posting Date", NewApplicationDate);
                        if NSApplyUnapplyPara3.FindSet() then
                            Applied := CustEntryApplyPostedEntries.Apply(Rec, NSApplyUnapplyPara3);
                    end;
