page 14021313 "NSPPFinanceAccountRolecenter"
{
        ...
        area(sections)
        {
            ...
            group("NS_ProjectProReports")
            {
                ...
                group("NS_Finance")
                {
                    ...
                    {
                        ApplicationArea = All;
                        Caption = 'Job Aged Accounts Payable';//PE-141.NK.1.0 Start 22Aug2023
                        Tooltip = ' Job Aged Accounts Payable';//PE-141.NK.1.0 Start 22Aug2023
                        Image = "Report";
