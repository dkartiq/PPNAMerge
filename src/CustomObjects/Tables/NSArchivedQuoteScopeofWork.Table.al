table 14021434 "NS_Archived Quote ScopeofWork"
{
    // version PPNA11.00
    ...
    fields
    {
        ...
        {
            Caption = 'Job No.';//PRJ-659.RS.1.0�18June21 New Added
            DataClassification = CustomerContent;
        }
        field(102; NS_Revision; Integer)
        {
    ...
    keys
    {
        key(Key1; "NS_Quote No.", "NS_Quote Line No.", "NS_Line No.", "NS_Segment Code", NS_Revision)
        {
        }
    }
