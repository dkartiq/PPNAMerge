...
/// <summary>
/// Report NS_Comb_N2AIAG702andAIAG703 (ID 14021144).
/// </summary>
//PE-42.RM.1.0 06Feb2023 | Changed in Layout only 
report 14021144 "NS_Comb_N2AIAG702andAIAG703"
{

    //PRJ-1708.JS.1.0 15DEC2022  New Report
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/CombN2AIAG702andAIAG703.rdl';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    Caption = 'Combined SubLevel AIAG702 and AIAG703';
    ...
    dataset
    {
        dataitem("Progress Billing Header"; "NS_Progress Billing Header")
        {
            ...
            begin
                ...
                //NS_GetChangeOrderValuesNew(Job."No.",
                ...
                Line_02_Value := PreviousAdditions - PreviousDeductions + CurrentAdditions - CurrentDeductions;   //PRJ-1708.JS.1.0
                Line_03_Value := Line_01_Value + Line_02_Value;
                Line_04_Value := WorkPreviousBilling + "NS_Requisition Total";


                Line_05a1_Value := Round("NS_Work Retention Percent", 0.0001);
    ...
    var
        ...
        WorkPreviousBilling2: Decimal;
        WorkRetTotal: Decimal;
        NSLineWorkRetnAmt: Decimal;
        NSLineStoreRetnAmt: Decimal;
        ...
        Line_Heading_5a_Lbl: Label 'a.   Amount of Completed Work';
        Line_Heading_5b_Lbl: Label 'b.   Amount of Stored Material';
