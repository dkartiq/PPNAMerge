report 14021328 "NS_Aged Acc. Receivable By Job"
{
    ...
    //PRJ-1240.RM.1.0 14March2022 Added Job No. on Report
    Caption = 'Aged Account Receivable By Job';
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/AgedAccReceivableByJob.rdl';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem(Totals; "Integer")
            {
                ...
                column(Cust_Ledger_Entry_Job_Description; JobDescription)
                {
                }
                ...
                //PRJ-1581.GK.1.0 30Aug2022 start
                column(NSRetAmnt; DocRetentionAmt)
                {

                }
                //PRJ-1581.GK.1.0 30Aug2022 end
                ...
                begin
                    ...
                    job.reset;
                    IF "Cust. Ledger Entry"."NS_Job No." <> '' then begin
                        IF job.GET("Cust. Ledger Entry"."NS_Job No.") THEN
                            JobDescription := job.Description;
                    end;
                    //PRJ-1581.GK.1.0 30Aug2022 start
                    Clear(DocRetentionAmt);
                    JobsSetup.Get();
                    SalesSetup.Get();
                    if not SalesSetup."NS_Sales Retention Inactive" then begin
                        ...
                        if CustLedgerEntry.FindSet() then begin
                            repeat
                                ...
                                DocRetentionAmt += CustLedgerEntry."Remaining Amt. (LCY)";
    ...
    var
        ...
        CustLedgerEntry: Record "Cust. Ledger Entry";//PRJ-1581.GK.1.0 30Aug2022
        DocRetentionAmt: Decimal;//PRJ-1581.GK.1.0 30Aug2022
