report 14021233 "NS_Per BillingRev CatSumm."
{
    // version NAVNA13.01
    ...
    //CTSI-150.AS.1.0 28Sept2020 New Report by saving extended 14021230 report
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/NSPercent Billing - Rev. Cat. Summ.rdl';

    Caption = 'Percent Billing - Rev. Cat. Summ.';//CTSI-42.AS.1.0 13May2020 : Changed Caption 
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                DataItemTableView = SORTING("NS_Job Revenue Category") ORDER(Ascending);//CTSI-42.AS.1.0
                dataitem(SalesLineComments; "Sales Comment Line")
                {
                    ...
                    //   "Print On Invoice" = CONST(true)); //PPDA1.0 Commented
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(RetentionAmount; "Sales Invoice Header"."NS_Retention Amount")
                    {
                    }
                    ...
                    dataitem(SalesInvLine; Integer)
                    {
                        ...
                        column(CurrPercentBilled; CurrPercentBilled)
                        {
                            //CTSI-150.AS.1.0 28Sept2020 
                        }
                        ...
                        begin
                            ...
                            Clear(CurrPercentBilled);//CTSI-150.AS.1.0 28Sept2020 
                            clear(ScheduledValue);//CTSI-150.AS.1.0 28Sept2020
                            ...
                            WITH TempSalesInvoiceLine DO BEGIN
                                ...
                                CurrPercentBilled := "Line Amount";
                                ScheduledValue := "NS_From Prog. Billing Base Amount";
                        ...
                        begin
                            ...
                            TempSalesInvoiceLine.SetCurrentKey("NS_Job Revenue Category");
    ...
    var
        ...
        RevenueCatToStore: Code[20];//CTSI-42.AS.1.0 08May2020
        ...
        CurrPercentBilled: decimal;//CTSI-150.AS.1.0 28Sept2020
        ScheduledValue: decimal;//CTSI-150.AS.1.0 28Sept2020
        ...
        UnitCaptionLbl: TextConst ENU = '', ESM = 'Unidad', FRC = 'Unité', ENC = 'Unit';
