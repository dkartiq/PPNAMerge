...
/// <summary>
/// Report NSUPDRevRec_IncSubLevel_FBTT (ID 14021236).
/// </summary>
//PRJ-1435.JS.1.0 06JUN2022 | Correct Code
report 14021236 "NSUPDRevRec_IncSubLevel_FBTT"
{
    //PRJ-1299.JS.1.0 New Report


    ProcessingOnly = true;
    Caption = 'Upd RecRevSummDtlsJFW IncludeSubLevel By Task Totals';
                    ...
                    if SLJob.FindSet() then
                        repeat
                            ...
                            if RecForecastSummDetail.FindLast() then begin
                                ...
                                //SLBillingToDate := SLBillingToDate + GetBillingtoDateIncludeSubLevels(SLJob."No.", AsofDateForecast);//PRJ-830 //PE-175.JS.1.0 11OCT2023 add ABS function
    ...
    begin
        ...
        if JobLedEntry2.FindSet() then begin
            ...
            //SumOfTotalCostsUsed += round(SumOfTotalCostsUsed + ABS(JobLedEntry."Total Price (LCY)"), Jobsetup."NS_Forecast Amount Rounding"); //New line Added //PRJ-1435.JS.1.0 06JUN2022 line commented
            SumOfTotalCostsUsed := round(SumOfTotalCostsUsed + JobLedEntry2."Total Price (LCY)", Jobsetup."NS_Forecast Amount Rounding"); //PRJ-1435.JS.1.0 06JUN2022 New line Added //PE-175.JS.1.0 11OCT2023 add ABS function
        end;
        SumOfTotalCostsUsed := SumOfTotalCostsUsed;  //PRJ-1435.JS.1.0 06JUN2022 New line Added //PE-175.JS.1.0 11OCT2023 remove ABS function
