/// <summary>
/// Report NS_UPD RRSumDtls By TaskTotals (ID 14021238).
/// </summary>
report 14021238 "NS_UPD RRSumDtls By TaskTotals"
{
    //PRJ-1299.JS.1.0 New Report for Job forecast by Task Totals

    ProcessingOnly = true;
    Caption = 'UPD Rec.Rev.Summ.Detail JFW FBTT';
            ...
            dataitem(ForecastSummDetail; "NS_Percentage of Completion")
            {
                ...
                begin
                    ...
                    Clear(Underbilling);//PRJ-830
                                        //PE-175.JS.1.0 18Dec2023 Start Code Added
                                        //PRJ-1539.GK.1.0 03Nov2022 start
                    if RecJob.get(MasterJobno) AND (RecJob."NS_Include Sub Levels") then begin
                        ...
                        if SLJob.FindSet() then
                            repeat
                                ...
                                if RecForecastSummDetail.FindLast() then begin
                                    ...
                                    //SLBillingToDate := SLBillingToDate + GetBillingtoDateIncludeSubLevels(SLJob."No.", AsofDateForecast);//PRJ-830 //PE-175.JS.1.0 11OCT2023 line commented
                    ...
                    //PRJ-1539.GK.1.0 03Nov2022 end
                    //PE-175.JS.1.0 18Dec2023 End 

                    //PE-175.JS.1.0 18Dec2023 below Code Blocked 
                    ...
                    //     //Statistics page calculations    
                    //     until SLJob.next = 0;
                    //PE-175.JS.1.0 18Dec2023 End Blocked
