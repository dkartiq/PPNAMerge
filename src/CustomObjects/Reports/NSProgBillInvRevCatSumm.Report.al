report 14021425 "NS_Progress Bill InvRevCatSumm"
{
    // version PPNA11.00
    ...
    //PRJ-702.AS.1.0 FULL REPORT MIGRATE FROM CTSI WITH RDLC
    //PRJ-1239.JS.1.0 08MAR2022 | correct code for decimal please issue
    //PRJ-1216.JS.5.0 28MAR2022
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/NSProgress Billing Invoice Rev Cat Summ.rdl';
    ...
    dataset
    {
        dataitem("Progress Billing Header"; "NS_Progress Billing Header")
        {
            ...
            column(Page_Number; CurrReport.PAGENO)
            {
            }
            ...
            dataitem("Progress Billing Line"; "NS_Progress Billing Line")
            {
                ...
                column(Revenue_Cat_Description; "NS_Revenue Cat Description")
                {
                    /////
                }
                column(Revenue_Category; "NS_Revenue Category")
                {

                }
                column(Item_No_; "NS_Item No.")
                {
                ...
                begin
                    ...
                    OK := false;
                    if (DetailJob.Status >= DetailJob.Status::Open) and
                    ...
                    if "NS_Billing Method" > 0 then begin
                        ...
                        DBalanceToFinish := DScheduledValue - DTotalCompletedAndStored;//DThisPeriod;//PRJ-630.MS.1.0
            ...
            begin
                ...
                if JobContact.GET("NS_Job No.", "NS_Owner Contact Type", "NS_Owner Contact Code") then begin
                    ...
                    PP_FormatAddress.NS_JobContact(CustomerAddress, JobContact)
                end else begin
                ...
                if JobContact.FINDSET then
                    PP_FormatAddress.NS_JobContact(AEAddress, JobContact)
                else
                    CLEAR(AEAddress);
                ...
                //LessPreviousInvoices := NS_ProgressBillPreviousInvoice("Progress Billing Header");  //Line 7  //PRJ-1216.JS.5.0 28MAR2022 line connentd
    ...
    var
        ...
        PP_FormatAddress: Codeunit "NS_Format Address";
        ...
        DRetention: Decimal;
        JobAddress: array[8] of Text;
        CustomerAddress: array[8] of Text;
        AEAddress: array[8] of Text;
        CompanyAddress: array[8] of Text;
        ItemNo: Integer;
        RevenueRec: Record "NS_Job Revenue Category";
        ...
        Invoice_Number__CaptionLbl: Label 'Progress Billing Number:';
