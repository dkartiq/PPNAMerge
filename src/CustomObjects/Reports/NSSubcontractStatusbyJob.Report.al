report 14021301 "NS_Subcontract Status by Job"
{
    // version PPNA11.00
    ...
    //PRJ-218:AS:14April2020 : Changed the layout from "Subcontract Status by Job.rdlc" to "Subcontract Status by Job_New.rdlc"
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/NSCustomized subcontract Status by Job_New.rdl';//PRJ-218:AS:14April2020
    ...
    dataset
    {
        dataitem(Job; Job)
        {
            ...
            column(Job_FilterCaption; JobFilterLbl)
            {
            }
            ...
            dataitem(Header; NS_Subcontract)
            {
                ...
                column(Job_No_Totals; JobLbl + Job."No." + TotalsLbl)
                {
                }
                dataitem(A_Header; NS_Subcontract)
                {
                    ...
                    dataitem(B_Detail; "NS_Subcontract Lines")
                    {
                        ...
                        column(B_DescriptionCaption; B_DescriptionLbl)
                        {
                        }
                        ...
                        column(B_Description; NS_Description)
                        {
                        }
    ...
    var
        ...
        PageLbl: Label 'Page';
        ReportTitleLbl: Label 'Subcontract Status by Job';
        JobFilterLbl: Label 'Job Filter: ';
        ...
        B_JobCostCategoryLbl: Label 'Job Cost Category';
        B_DescriptionLbl: Label 'Description';
