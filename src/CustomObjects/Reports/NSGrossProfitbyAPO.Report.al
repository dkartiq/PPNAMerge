report 14021154 "NS_Gross Profit by APO"
{
    // version PPNA11.00
    ...
    dataset
    {
        dataitem(Job; Job)
        {
            ...
            dataitem("Page Header"; Integer)
            {
                ...
                column(ActualProfitCaption; ActualProfitLbl)
                {
                }
                column(PercentProfitCaption; PercentProfitLbl)
                {
                }
    ...
    var
        ...
        ReportTitle: Label 'Gross Profit by APO';
        PageLbl: Label 'Page';
        JobFiltersLbl: Label 'Job Filters:';
        DescriptionLbl: Label 'Description';
        NoLbl: Label 'No.';
        TypeHeading: Label 'Type';
        ActualPriceLbl: Label 'Actual Price';
    ...
    begin
        ...
        WITH JobLedgerEntry DO BEGIN
            ...
            END ELSE BEGIN
                ...
                JobReportBuffer1."NS_Actual Price" := -"Line Amount (LCY)";//PRJ-849.AS.0 Add
