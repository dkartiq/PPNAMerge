report 14021338 "NS_Progress Billing Invoice CO"
{
    //PE-207.NC.1.0 06Nov2023 New Report Create
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/NSProgress Billing Invoice CO.rdl';
    WordLayout = './Layouts/NSProgress Billing Invoice CO.docx';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    Caption = 'Combined CO Progress Billing Invoice';
    ...
    dataset
    {
        dataitem("Progress Billing Header"; "NS_Progress Billing Header")
        {
            ...
            dataitem("Progress Billing Line"; "NS_Progress Billing Line")
            {
                ...
                begin
                    ...
                    if "NS_Billing Method" > 0 then begin
                        ...
                        DBalanceToFinish := DScheduledValue - DThisPeriod - DPreviousPeriod - DStoredMaterialsAmount;
            ...
            begin
                ...
                PreviousRetention := NS_PreviousProgressBillRetention("Progress Billing Header", '', '', '', '', '', '');
                ...
                NS_GetChangeOrderValuesBasedonPBLines(Job."No.",
                ...
                PeriodTo := FORMAT("NS_Period To", 0, '<Month,2>/<Day,2>/<Year4>');
                CustomerJobNo := Job."NS_Customer Job No.";
                CustomerIDNo := Job."Bill-to Customer No.";
                ContractDate := FORMAT(Job."NS_Contract Date", 0, '<Month,2>/<Day,2>/<Year4>');
                InvoiceDate := Format("NS_Requisition Date", 0, '<Month,2>/<Day,2>/<Year4>');
                OriginalContractSum := NS_ProgressBillBaseAmount("Progress Billing Header");
                ...
                TotalCompletedAndStoredToDate := WorkPreviousBilling + "NS_Requisition Total";

                if "NS_Work Retention Percent" <> 0 then begin
                    RetentionPercentOfCompletedWork := ROUND((WorkPreviousBilling + "NS_Line Work Amount") * ("NS_Work Retention Percent" / 100), 0.01);
                ...
                LessPreviousInvoices := NS_ProgressBillPreviousInvoiceNew("Progress Billing Header");  //Line 7   
    ...
    var
        ...
        Invoice_CaptionLbl: Label 'Combined CO Progress Billing Report';
        Invoice_Number__CaptionLbl: Label 'Progress Billing No.:';
