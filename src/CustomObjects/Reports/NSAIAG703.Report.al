report 14021326 "NS_AIA G703"
{
    ...
    //PRJ-91.SK.1.0 Added code for clearing the variables so that they cant pick previous values
    //PPAL-105 N.S.1.0 14AUG2020 Change in descrption
    //CTSI-117.MS.1.0  job no. change to no.
    //PRJ-934.GK.1.0 14Oct2021 | Change DataItemTableView property 
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/NSAIA G703.rdl';
    ...
    dataset
    {
        dataitem("Progress Billing Header"; "NS_Progress Billing Header")
        {
            ...
            dataitem("Progress Billing Line"; "NS_Progress Billing Line")
            {
                ...
                // DataItemTableView = SORTING("NS_Progress Billing No.", "NS_Requisition No.", "NS_Line No.", "NS_Version No.", "NS_Item No.", "NS_Job No.", "NS_Revenue Category", "NS_Job Task No.") ORDER(Ascending)//PRJ-934.GK.1.0 14Oct2021 | Comment Code
                DataItemTableView = SORTING("NS_Progress Billing No.", "NS_Requisition No.", "NS_Line No.", "NS_Version No.", "NS_Item No.", "NS_Job No.", "NS_Revenue Category", "NS_Job Task No.") ORDER(Ascending) Where("NS_Billing Method" = filter("%" | Unit | "L/S"), "NS_Scheduled Values" = filter(<> 0)); //PRJ-934.GK.1.0 14Oct2021 |Add Code
